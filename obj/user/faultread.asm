	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ea:	0f be 80 fc 0d 80 00 	movsbl 0x800dfc(%eax),%eax
  8001f1:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002f1:	ff 24 85 8c 0e 80 00 	jmp    *0x800e8c(,%eax,4)
  ...
  8003b5:	8b 14 85 e4 0f 80 00 	mov    0x800fe4(,%eax,4),%edx
  8003bc:	85 d2                	test   %edx,%edx
  8003be:	75 18                	jne    8003d8 <vprintfmt+0x165>
				printfmt(putch, putdat, "error %d", err);
  8003c0:	50                   	push   %eax
  8003c1:	68 14 0e 80 00       	push   $0x800e14
  8003c6:	53                   	push   %ebx
  8003c7:	56                   	push   %esi
  ...
  8003d8:	52                   	push   %edx
  8003d9:	68 1d 0e 80 00       	push   $0x800e1d
  8003de:	53                   	push   %ebx
  8003df:	56                   	push   %esi
  ...
  8003fd:	b8 0d 0e 80 00       	mov    $0x800e0d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ab3:	68 00 10 80 00       	push   $0x801000
  800ab8:	6a 23                	push   $0x23
  800aba:	68 1d 10 80 00       	push   $0x80101d
...
sys_getenvid(void)
{
  ...
  800aeb:	50                   	push   %eax
  800aec:	68 2b 10 80 00       	push   $0x80102b
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b1c:	56                   	push   %esi
  800b1d:	50                   	push   %eax
  800b1e:	68 40 10 80 00       	push   $0x801040
  ...
  800b2f:	e8 b7 f5 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800b34:	c7 04 24 f0 0d 80 00 	movl   $0x800df0,(%esp)
