	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80022f:	0f be 80 48 10 80 00 	movsbl 0x801048(%eax),%eax
  800236:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002f1:	ff 24 85 00 11 80 00 	jmp    *0x801100(,%eax,4)
  ...
  8003b8:	8b 14 85 60 12 80 00 	mov    0x801260(,%eax,4),%edx
  8003bf:	85 d2                	test   %edx,%edx
  8003c1:	75 1b                	jne    8003de <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  8003c3:	50                   	push   %eax
  8003c4:	68 60 10 80 00       	push   $0x801060
  8003c9:	53                   	push   %ebx
  8003ca:	56                   	push   %esi
  ...
  8003de:	52                   	push   %edx
  8003df:	68 69 10 80 00       	push   $0x801069
  8003e4:	53                   	push   %ebx
  8003e5:	56                   	push   %esi
  ...
  800409:	b8 59 10 80 00       	mov    $0x801059,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b31:	68 84 12 80 00       	push   $0x801284
  800b36:	6a 23                	push   $0x23
  800b38:	68 a1 12 80 00       	push   $0x8012a1
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bb2:	68 84 12 80 00       	push   $0x801284
  800bb7:	6a 23                	push   $0x23
  800bb9:	68 a1 12 80 00       	push   $0x8012a1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bf4:	68 84 12 80 00       	push   $0x801284
  800bf9:	6a 23                	push   $0x23
  800bfb:	68 a1 12 80 00       	push   $0x8012a1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c36:	68 84 12 80 00       	push   $0x801284
  800c3b:	6a 23                	push   $0x23
  800c3d:	68 a1 12 80 00       	push   $0x8012a1
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c78:	68 84 12 80 00       	push   $0x801284
  800c7d:	6a 23                	push   $0x23
  800c7f:	68 a1 12 80 00       	push   $0x8012a1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cba:	68 84 12 80 00       	push   $0x801284
  800cbf:	6a 23                	push   $0x23
  800cc1:	68 a1 12 80 00       	push   $0x8012a1
...
sys_ipc_recv(void *dstva)
{
  ...
  800d1e:	68 84 12 80 00       	push   $0x801284
  800d23:	6a 23                	push   $0x23
  800d25:	68 a1 12 80 00       	push   $0x8012a1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d53:	56                   	push   %esi
  800d54:	50                   	push   %eax
  800d55:	68 b0 12 80 00       	push   $0x8012b0
  ...
  800d66:	e8 c5 f3 ff ff       	call   800130 <vcprintf>
	cprintf("\n");
  800d6b:	c7 04 24 3c 10 80 00 	movl   $0x80103c,(%esp)
